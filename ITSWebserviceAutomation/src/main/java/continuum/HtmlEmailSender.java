...
public class HtmlEmailSender {
	...
	public static void sendReport(){
		if(Utility.getMavenProperties("reportMail").equalsIgnoreCase("true"))
		{
			...
			String subject= "SoapUI WebService Report for " + Utility.getMavenProperties("ProjectName");
			//System.out.println("Sending "+subject);				
			String message="SoapUI WebService Report for " + Utility.getMavenProperties("ProjectName");
